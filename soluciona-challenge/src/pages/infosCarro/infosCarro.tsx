    ...
    const handleCarroChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        switch (valor) {
            ...
            case 'veiculo2':
                ...
                break;
            case 'veiculo3':
                infoCarro = { placa: 'GHI-9012', marca: 'Renault', modelo: 'Sandero', ano: '2019', ano_modelo: '2019', numero_chassi: '1122334455', combustivel: 'Flex', motor: '1.6', valor: '50.000' };
                break;
            default:
        ...
        <>
            ...
            <main className="container-infos-carro">
                ...
                <div className="btn-adiciona">
                    <Link to='/cadastroVeiculo'><button>Adicionar novo carro</button></Link>
                </div>
            </main>
            <Footer />
        </>
