            ...
            <main className="container-orcamentos">
                ...
                <div className={`resultado-orcamento ${orcamento ? 'show' : ''}`}>
                    <p>Após a avaliação do seu veículo, identificamos a necessidade de realizar a troca da {inputValue}. Essa manutenção é essencial para garantir a segurança e o bom funcionamento do seu carro. <br /><br />
                        ...
                        <br />
                        Para agendar o serviço ou obter mais informações, entre em contato conosco ou diretamente com a oficina. Para ver as oficinas próximas <Link className="link-orcamento" to='/oficinas'>clique aqui</Link>. Estamos à disposição para atendê-lo e garantir a sua segurança nas estradas.
                        <br />
                        Atenciosamente,<br />
                        <span>[SolucIonA]</span>
                        </p>
